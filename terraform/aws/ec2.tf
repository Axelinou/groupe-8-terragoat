...
resource "aws_security_group" "web-node-secure" {
  ...
  tags = {
    Name                 = "${local.resource_prefix.value}-sg-secure"
    Environment          = local.resource_prefix.value
    git_commit           = "3fcc4a2ed8bdcc9adccd76fdb318b8db6f03cf5f"
    git_file             = "terraform/aws/ec2.tf"
    git_last_modified_at = "2026-06-25 08:11:20"
    git_last_modified_by = "axelberasmus@gmail.com"
    git_modifiers        = "axelberasmus"
    git_org              = "Axelinou"
    git_repo             = "groupe-8-terragoat"
    yor_name             = "web-node-secure"
    yor_trace            = "8e7a9e83-3d78-49ec-9b36-696d74719158"
  }
}
...
resource "aws_iam_instance_profile" "web_host_profile" {
  ...
  tags = {
    git_commit           = "d1f0dd4955628072fd899a2d4a7aa7d250b2a61c"
    git_file             = "terraform/aws/ec2.tf"
    git_last_modified_at = "2026-06-25 09:22:01"
    git_last_modified_by = "axelberasmus@gmail.com"
    git_modifiers        = "axelberasmus"
    git_org              = "Axelinou"
    git_repo             = "groupe-8-terragoat"
    yor_name             = "web_host_profile"
    yor_trace            = "8e503805-876e-4cd0-af90-70e880e4ae36"
  }
}
